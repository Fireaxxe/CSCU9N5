window.onload = function () {
    ...
    startSound.src = "assets/sounds/archerGame/whistlestart.ogg"
    startSound.volume = 0.03;

    var shootSound = new Audio();
    shootSound.src = "assets/sounds/archerGame/arrow.ogg";

    var hitSound = new Audio();
    hitSound.src = "assets/sounds/archerGame/arrowhit.ogg";
    hitSound.volume = 0.2;

    var bgSound = new Audio();
    bgSound.src = "assets/sounds/archerGame/bg.ogg";
    bgSound.loop = true;
    bgSound.volume = 0.1;

    var endSound = new Audio();
    endSound.src = "assets/sounds/archerGame/whistleover.ogg";
    endSound.volume = 0.03;

    var successSound = new Audio();
    successSound.src = "assets/sounds/archerGame/bell.ogg";
    successSound.volume= 0.5;

    var highScoreSound = new Audio();
    highScoreSound.src = "assets/sounds/archerGame/crowdcheer.ogg";
